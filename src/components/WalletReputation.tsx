...
import { fetchMLPrediction } from '../utils/mlService';
import { generateMockTransaction } from '../utils/mockData'; // Use the same generator
                    ...
                    <div className="flex flex-col items-end space-y-3">
                      ...
                      <div className="flex space-x-2">
                        ...
                        onClick={async () => {
                          ...
                          tx.from = wallet.address; // ✅ Overriding the sender
                          try {
                            const result = await fetchMLPrediction(tx);
                            alert(`ML Prediction: ${JSON.stringify(result)}`);
                          } catch (error) {
                            alert('ML API call failed');
                          }
                        }}
